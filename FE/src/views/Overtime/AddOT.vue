                ...
                <div class="card">
                    ...
                    <form @submit.prevent="handleSubmit(!v$.$invalid)" class="p-fluid">
                        ...
                        <div class="button-div">
                            ...
                            <button type="button" class="btn btn-secondary" v-on:click="backToOT()">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getUserByProject(projectid){
                HTTP.get("Project/UserInProject/" + projectid).then(res=>{
