    ...
    <LayoutDefaultDynamic>
            ...
            <div class="adduser__div">
                <div class="adduser__div-form">
                    <div class="adduser__div-form-title">
                        Add new User
                    </div>
                  <form class=adduser__div-form-content>
                        ...
                        <div class="adduser__div-form-content-items">
                                      <!-- Account -->
                                    <div class="p-float-label" :class="{ 'form-group--error': v$.userCode.$error } +' div__inputtext'">
                                        <InputText id=" userCode" v-model="v$.userCode.$model"
                                            :class="{ 'p-invalid': v$.userCode.$invalid && submitted } + ' inputtext__admin'" />
                                        <label for="userCode"
                                            :class="{ 'p-error': v$.userCode.$invalid && submitted }">Account*</label>
                                    </div>
                                    <span v-if="v$.userCode.$error && submitted">
                                        <span id="userCode-error" v-for="(error, index) of v$.userCode.$errors"
                                            :key="index">
                                    ...
                                    " class="p-error">{{ v$.userCode.required.$message.replace('Value', 'Account')
                                    }}</small>
                                        <!-- FirstName -->
                        ...
                        <div class="adduser__div-form-content-items">
                                ...
                                <div class="p-float-label div__inputtext">
                                    ...
                                    <span v-if="v$.password.$error && submitted">
                                        <span id="password-error" v-for="(error, index) of v$.password.$errors"
                                            :key="index">
                                            <small class="p-error">{{ error.$message }}</small>
                                        </span>
                                    </span>
