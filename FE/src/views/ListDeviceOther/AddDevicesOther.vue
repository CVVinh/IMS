<template>
    ...
    <Dialog
        :header="orderSelected.idOrder ? 'EDIT ORDER' : 'ADD ORDER'"
    ...
    >
        <div class='container'>
            <form ref='formAddEditOrder' class='p-fluid' @submit.prevent='saveData(!v$.$invalid)'>
                <div class='col-12 row'>
                    <div class='col-4'>
                        <div class='field mb-4'>
                            ...
                            />
                            <small
                                v-if='(v$.dataOrder.idBranch.$invalid && submitted) || v$.dataOrder.idBranch.$pending.$response'
                                class='p-error'
                    ...
                    <div class='col-4'>
                        <div class='field mb-4'>
                            ...
                            />
                            <small
                                v-if='(v$.dataOrder.idDevice.$invalid && submitted) || v$.dataOrder.idDevice.$pending.$response'
                                class='p-error'
                    ...
                    <div class='col-4'>
                        <div class='field mb-4'>
                            ...
                            />
                            <small
                                v-if='(v$.dataOrder.amount.$invalid && submitted) || v$.dataOrder.amount.$pending.$response'
                                class='p-error'
                ...
                <div class='col-12 row'>
                    <div class='field mb-4'>
                        <label for='amount' class='mb-2'>Note</label>
        ...
        methods: {
            ...
            saveData(isFormValid) {
                ...
                if (isFormValid) {
                    ...
                    this.dataOrder.dateUpdated = new Date();
                        HTTP.put('Orders/updateOrder', this.dataOrder).then(res => {
                            if (res.status === 200) {
                                this.showSuccess()
                                this.onClickCancel();
                                this.$emit('reloadpage');
                            }
                        }).catch(er => {this.showWarn()});
                    } else {
                        let userLogin = LocalStorage.jwtDecodeToken();
                    ...
                    this.dataOrder.userUpdated = userLogin.Id;
                    this.dataOrder.dateUpdated = new Date();
                        HTTP.post('Orders/addOrders', this.dataOrder).then(res => {
                            if (res.status === 200) {
                                this.showSuccess();
                                this.onClickCancel();
                                this.$emit('reloadpage');
            ...
            showSuccess() {
                this.$toast.add({
                    ...
                    detail: 'Save orders devices successfully !!!',
                    life: 3000,
                })
            },
            showWarn() {
                this.$toast.add({
                    ...
                    detail: 'Save orders devices failed !!!',
                    life: 3000,
                })
            },
            resetForm() {
