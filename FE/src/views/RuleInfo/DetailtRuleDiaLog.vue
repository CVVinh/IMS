<template>
    <Dialog :visible="statusopen" :closable="false" :modal="true" :maximizable="true" :dismissableMask="true" :show="resetForm()">
        ...
        <template #header>
            ...
            <div class="p-fluid ">
                ...
                <div class="row">
                    <div class="col-4">Created Date: {{ dateCreated }}</div>
                    <div class="col-4">Applicable Date: {{ applyDay }}</div>
                    <div class="col-4">Expiration Date: {{ expiredDay }}</div>
                </div>
            </div>
        </div>
        </template>
        ...
        <template #footer>
            <Button label="Cancel" icon="pi pi-times" class="p-button-secondary" @click="$emit('closeDetailt')" />
	    </template>
