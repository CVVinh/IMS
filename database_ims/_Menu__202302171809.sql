INSERT INTO public."Menu" ("idModule",title,icon,"view",controller,"action",parent,"isDeleted") VALUES
	 ...
	 (1,'Add Task','bx bxs-layer-plus','ViewSubmenuVue','addtask','click',1,0),
...
INSERT INTO public."Menu" ("idModule",title,icon,"view",controller,"action",parent,"isDeleted") VALUES
	 ...
	 (4,'Remotes','bx bx-notepad','ViewMenu','remotes','click',0,0),
	 ...
	 (9,'To Spend','bx bxs-credit-card','ViewMenu','toSpend','click',0,0),
